...
plt.plot(rad,amo,label="Amoniumsulfataerosol")
plt.plot(rad,seesalzschwer,label="Seesalzaerosol schwer")
plt.plot(rad,seesalzleicht,label="Seesalzaerosol leicht")
plt.axis([10**-9,10**-4,0.98,1.05])
plt.xlabel("Tropfenradius in m")
plt.ylabel( "Sättigungmischungsverhältniss")
plt.xscale("log")
plt.title("Vergleich verschiedener Köhlerkurven")
plt.legend()
plt.savefig("Steding-Alexander-wp02-plot.png",dpi=1200)